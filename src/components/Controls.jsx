  ...
  render() {
    return (
      <div className="Controls row">
        <div className={"Cell"} title="Easy" onClick={this.props.startGame.bind(this,"easy")} ><IoHappyOutline size={25} /></div>
        ...
        <div className={"Cell"} title="Solve puzzle" onClick={this.props.solve} ><IoColorWandOutline size={25} /></div>
        <div className={"Cell"} title="Restart puzzle" onClick={this.props.restartGame} ><IoRefresh size={25} /></div>
